                ...
                <div class="col-md-8">
                   @csrf                 
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="title" class="form-control  text-heading" id="texturl" cols="30" rows="10"></textarea>
                        <p class="small">http://localhost /<span id="url"></span></p>
                        <input type="hidden" name="slug" id="slug" value="">
                    </div>
                    <div class="form-group">
                        <label for="writername">Writer Name</label>
                        <input type="text" name="writer_name" class="form-control" id="writername" placeholder="Writer Name">
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                         ...
                         <select name="navparent" id="navparent" class="form-control">
                            <option value="news" class="text-capitalize">news</option>
                            <option value="health&welness" class="text-capitalize">health & welness</option>
                            <option value="fashion" class="text-capitalize">fashion</option>
                            <option value="tech" class="text-capitalize">tech</option>
                            <option value="business" class="text-capitalize">business</option>
                         </select>
                    </div> 
                    <div class="form-group">
